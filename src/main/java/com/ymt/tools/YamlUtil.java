...
public class YamlUtil {
    ...
    public static Config loadYaml(){
        ...
        try {
            ...
            YamlReader reader =  new YamlReader(new FileReader(confFile.getAbsolutePath()));
    ...
    public static  void main(String args[]){
        ...
        logger.info("{}",config.getBlackList());

        logger.info("{}",config.getTriggerActions().get(0).getTriggerCondition());
